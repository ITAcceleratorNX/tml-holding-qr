...
export const COMPANIES = [
  ...
  },
  {
    ...
    text: 'Буровые работы на твёрдых полезных ископаемых по всему Казахстану - геологоразведка высокой точности.',
    accent: '#BDA57E',
    accentFg: '#2B3F58',
    art: '/assets/img/brand/drilling-art.webp',
    artW: 1280,
    artH: 461,
    pills: ['Современное оборудование', 'Инженеры и геологи', 'Экостандарты'],
    minis: [
      { b: '6+', s: 'месторождений' },
